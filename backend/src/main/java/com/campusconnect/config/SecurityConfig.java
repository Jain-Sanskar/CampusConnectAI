...
public class SecurityConfig {
    ...
    // comma separated list of origins allowed to call the API (the React dev server in dev)
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                // stateless JWT API, so the usual browser CSRF protection doesn't apply
